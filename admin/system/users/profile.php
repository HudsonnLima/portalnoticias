...
<div class="content titulo">Olá <?= "{$user_name} {$user_lastname}"; ?>, atualize seu perfíl!</div>
    ...
    <article>
        ...
        <div class="form-group col-md-6">
            <div class="form-floating">
              <input type="text" name="user_name" class="form-control" id="floatingInput" value="<?= $user_name; ?>">
        ...
        <div class="form-group col-md-6">
            <div class="form-floating">
              <input type="text" name="user_lastname" class="form-control" id="floatingInput" value="<?= $user_lastname; ?>">
         ...
         <div class="form-group col-md-4">
            <div class="form-floating">
              <input type="text" name="user_email" class="form-control" id="floatingInput" value="<?= $user_email; ?>">
         ...
         <div class="form-group col-md-4">
                <div class="form-floating ">
                 ...
                 <option disabled="disabled" selected="selected" value=""> Seleciona o nível deste usuário: </option>                        
                       <option value = "1" <?php if (isset($user_level) && $user_level == 1) echo 'selected="selected"'; ?>>Usuário</option>
                        <option value="2" <?php if (isset($user_level) && $user_level == 2) echo 'selected="selected"'; ?>>Editor</option>
                        <option value="3" <?php if (isset($user_level) && $user_level == 3) echo 'selected="selected"'; ?>>Administrador</option>
                </select>
        ...
        <input type="submit" name="SendPostForm" value="Atualizar Perfil" class="btn btn-primary" />
        </form>
        </article>
